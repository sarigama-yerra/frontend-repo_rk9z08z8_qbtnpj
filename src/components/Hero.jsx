...
// Client-safe Spline loader to prevent crashes if the 3D scene fails to load
function SplineCanvas() {
  ...
  if (!SplineComp) {
    return (
      <div className="absolute inset-0 animate-pulse bg-gradient-to-br from-neutral-100 to-neutral-200 dark:from-neutral-900 dark:to-neutral-800" />
    );
  }
    ...
    <section className="relative pt-28 pb-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative h-[420px] rounded-2xl overflow-hidden border border-white/20 dark:border-white/10 bg-gradient-to-br from-neutral-50 to-white dark:from-neutral-900 dark:to-neutral-950">
          {/* Spline canvas with graceful fallback */}
          <SplineCanvas />
