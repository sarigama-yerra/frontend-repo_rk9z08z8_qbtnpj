...
export default class ErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, info) {
    // Optionally send error reports here
  }
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center p-6 text-center bg-white dark:bg-neutral-950 text-neutral-900 dark:text-white">
